...
local function setup_fzflua_keymaps()
    ...
    keymap_set("n", "<leader>sb", fzflua.grep_curbuf, "current-buffer")
    keymap_set("n", "<leader>sf", fzflua.files, "files")
    keymap_set("n", "<leader>sh", fzflua.search_history, "history")
    keymap_set("n", "<leader>sm", fzflua.marks, "marks")
    keymap_set("n", "<leader>sM", fzflua.man_pages, "man-pages")
    keymap_set("n", "<leader>sr", fzflua.oldfiles, "recent-files")
    keymap_set("n", "<leader>sR", fzflua.registers, "registers")
    ...
    keymap_set("n", "<leader>zf", fzflua.oldfiles, "recent-files")

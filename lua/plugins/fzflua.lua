...
local function setup_fzflua_keymaps()
    ...
    map("n", "<leader>oo", fzflua.lsp_document_symbols, "outline-document")
    map("n", "<leader>oO", fzflua.lsp_workspace_symbols, "Outline-Workspace")
    ...
    map("n", "<leader>zf", fzflua.oldfiles, "recent-files")
    ...
    map("n", "<leader>zL", fzflua.loclist_stack, "LLIST")
    map("n", "<leader>zm", fzflua.marks, "marks")
    map("n", "<leader>zM", fzflua.man_pages, "man-pages")
    map("n", "<leader>zo", fzflua.nvim_options, "options-nvim")
    map("n", "<leader>zr", fzflua.registers, "registers")
    map("n", "<leader>zq", fzflua.quickfix, "clist")
    map("n", "<leader>zQ", fzflua.quickfix_stack, "CLIST")
    map("n", "<leader>zv", fzflua.commands, "vim-commands")
    map("n", "<leader>zV", fzflua.command_history, "vim-command-history")
    map("n", "<leader>zx", fzflua.resume, "resume")
    map("n", "<leader>zz", fzflua.live_grep_resume, "live-grep")

...
keymap_set("n", "<leader>mlb", ":echo '`emacs` command 🫠'<CR>")
keymap_set("n", "<leader>mlc", ":echo '`emacs` command 🫠'<CR>")
keymap_set("n", "<leader>mle", ":echo '`emacs` command 🫠'<CR>")
keymap_set("n", "<leader>mlf", ":echo '`emacs` command 🫠'<CR>")
